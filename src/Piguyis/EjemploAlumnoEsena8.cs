...
namespace AlumnoEjemplos.Piguyis
{
    ...
    /// Ejemplo del alumno
    /// </summary>
    public class EjemploAlumnoEsena8 : TgcExample
    {
        /// <summary>
        ...
        {
            return "Muchas esferas desalineadas colisionan contra otra inmovil (masa infinita).";
        }

        private IEsena e = new Esena8();        
