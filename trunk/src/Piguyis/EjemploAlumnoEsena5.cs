...
namespace AlumnoEjemplos.Piguyis
{
    ...
    /// Ejemplo del alumno
    /// </summary>
    public class EjemploAlumnoEsena5 : TgcExample
    {
        /// <summary>
        ...
        {
            return "Muchas esferas alineadas colisionan contra otra inmovil (masa infinita).";
        }

        private IEsena e = new Esena5();        
